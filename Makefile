...
inject-version-info:
	...
	$(call inject-version-info,mica_distribution/modules/mica/extensions/mica_datasets,mica_dimensions_coverage_tab,$(mica_version))
...
clear-version-info: compile-less
	...
	$(call clear-version-info,src/main/drupal/modules/mica/extensions/mica_datasets,mica_dimensions_coverage_tab)
