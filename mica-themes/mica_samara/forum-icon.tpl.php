...
/**
 * @file
 * Theme implementation to display an appropriate icon for a forum post.
 *
 * Available variables:
 ...
 *  @see http://drupal.org/node/1021724
 * 
...
<?php if ($first_new): ?>
  <a id="new"></a>
<?php endif; ?>
  <span class="element-invisible"><?php print $icon_class ?></span>
</div>
