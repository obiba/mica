...
mica-delete-9.0: mica-delete-module-9.0 mica-delete-library-9.0 mica-delete-theme-9.0
	$(call delete-profile,mica_distribution)

mica-delete-theme-9.0:
	$(call delete-theme,bootstrap) && \
	$(call delete-theme,mica_bootstrap)

mica-delete-library-9.0:
	$(call delete-library,ckeditor) && \
	$(call delete-library,jquery_tooltip) && \
	$(call delete-library,prettify) && \
	$(call delete-library,jquery-ui-multiselect-widget) && \
	$(call delete-library,SolrPhpClient) && \
	$(call delete-library,datatables)

mica-delete-module-9.0:
...
mica-delete-9.0-dev: mica-delete-9.0
mica-delete-9.0-rc1: mica-delete-9.0
mica-delete-9.0-rc2: mica-delete-9.0
mica-delete-9.0-rc3: mica-delete-9.0
mica-delete-9.0-rc4: mica-delete-9.0
mica-delete-9.0-rc5: mica-delete-9.0
mica-delete-9.0-rc6: mica-delete-9.0
mica-delete-9.0-rc7: mica-delete-9.0
mica-delete-9.0-rc8: mica-delete-9.0
mica-delete-9.0-rc9: mica-delete-9.0

mica-delete-9.1-dev: mica-delete-9.0
mica-delete-9.1-rc1: mica-delete-9.0
mica-delete-9.1-rc2: mica-delete-9.0
mica-delete-9.1-rc3: mica-delete-9.0
mica-delete-9.1-rc4: mica-delete-9.0
mica-delete-9.1-rc5: mica-delete-9.0
mica-delete-9.1-rc6: mica-delete-9.0
...
mica-delete-9.2-rc4: mica-delete-9.0
mica-delete-9.2-rc5: mica-delete-9.0
mica-delete-9.2-rc6: mica-delete-9.0
mica-delete-9.2-rc7: mica-delete-9.0
mica-delete-9.2: mica-delete-9.0

mica-delete-9.3-rc1: mica-delete-9.0
mica-delete-9.3-rc2: mica-delete-9.0
mica-delete-9.3-rc3: mica-delete-9.0
mica-delete-9.3-rc4: mica-delete-9.0
mica-delete-9.3-rc5: mica-delete-9.0
mica-delete-9.3-rc6: mica-delete-9.0
mica-delete-9.3-rc7: mica-delete-9.0
mica-delete-9.3: mica-delete-9.0
