...
namespace Math {
  ...
  class DefaultSummaryDto extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor() {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Math.DefaultSummaryDto');
...
namespace Math {
  ...
  class BinarySummaryDto extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor() {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'Math.BinarySummaryDto');
...
namespace {
  ...
  \Math\SummaryStatisticsDto::extension(function () {
    // OPTIONAL MESSAGE Math.DefaultSummaryDto.defaultSummary = 1002
    $f = new \DrSlump\Protobuf\Field();
    $f->number = 1002;
    $f->name = "Math.DefaultSummaryDto.defaultSummary";
    $f->type = \DrSlump\Protobuf::TYPE_MESSAGE;
    $f->rule = \DrSlump\Protobuf::RULE_OPTIONAL;
    $f->reference = '\Math\DefaultSummaryDto';
    return $f;
  });
  \Math\SummaryStatisticsDto::extension(function () {
    // OPTIONAL MESSAGE Math.BinarySummaryDto.binarySummary = 1003
    $f = new \DrSlump\Protobuf\Field();
    $f->number = 1003;
    $f->name = "Math.BinarySummaryDto.binarySummary";
    $f->type = \DrSlump\Protobuf::TYPE_MESSAGE;
    $f->rule = \DrSlump\Protobuf::RULE_OPTIONAL;
    $f->reference = '\Math\BinarySummaryDto';
    return $f;
  });
}