(function () {
    ...
    function zn(t, n, e, r) {
        ...
        if (!a) {
            var o = r.time;
            return a = u[e] = {tween:new i, event:d3.dispatch("start", "end"), time:o, ease:r.ease, delay:r.delay, duration:r.duration}, ++u.count, d3.timer(function (r) {
                function i(r) {
    ...
    function ee(t, n) {
        ...
        return e.domain = function (r) {
            ...
            return a = r(2 > t.length ? (c + l) / 2 : c + s * i / 2, s), o = 0, n = {t:"rangePoints", a:arguments}, e
            ...
            return a = r(s + h * c, h), l && a.reverse(), o = h * (1 - i), n = {t:"rangeBands", a:arguments}, e
        }, e.rangeRoundBands = function (u, i, c) {
            2 > arguments.length && (i = 0), 3 > arguments.length && (c = i);
            var l = u[1] < u[0], s = u[l - 0], f = u[1 - l], h = Math.floor((f - s) / (t.length - i + 2 * c)), d = f - s - (t.length - i) * h;
            return a = r(s + Math.round(d / 2), h), l && a.reverse(), o = Math.round(h * (1 - i)), n = {t:"rangeRoundBands", a:arguments}, e
        ...
        return e.parse = function (t) {
            ...
            function e() {
                ...
                for (; l > s;) {
                    ...
                    if (10 === r)u = !0; else if (13 === r)u = !0, 10 === t.charCodeAt(s) && (++s, ++c); else if (r !== o)continue;
    ...
    function nu(t) {
        function n(n) {
            ...
            var l, s, f, h, d, g, p = {point:r, lineStart:i, lineEnd:o, polygonStart:function () {
    ...
    function su(t, n, e) {
        return function (r) {
            ...
            var f, h, d, g, p, m = n(r), v = {point:u, lineStart:a, lineEnd:o, polygonStart:function () {
    ...
    function Mu(t, n, e, r) {
        var u;
        if (null == t)u = e * Ri / 2, r.point(-Ri, u), r.point(0, u), r.point(Ri, u), r.point(Ri, 0), r.point(Ri, -u), r.point(0, -u), r.point(-Ri, -u), r.point(-Ri, 0), r.point(-Ri, u); else if (Math.abs(t[0] - n[0]) > Pi) {
    ...
    function Tu() {
        ...
        var i = Au(4.5), a = [], o = {point:t, lineStart:function () {
            o.point = n
    ...
    function Hu() {
        function t(t, n) {
            if (t *= ji, n *= ji, !(Pi > Math.abs(Math.abs(i) - Ri / 2) && Pi > Math.abs(Math.abs(n) - Ri / 2))) {
                ...
                if (Pi > Math.abs(i - Ri / 2))Mo += 2 * (t - r); else {
    ...
    function $u(t, n) {
        var e = {list:t.map(function (t, n) {
            ...
            return f && "l" === i.side || !f && "r" === i.side ? null : {x:o, y:c}
    ...
    d3.functor = c, d3.rebind = function (t, n) {
        ...
        if (1 === arguments.length)for (; r > ++i;)s(e = t[i]) && (u += (e - u) / ++a); else for (; r > ++i;)s(e = n.call(t, t[i], i)) && (u += (e - u) / ++a);
        return a ? u : void 0
    ...
    d3.ns = {prefix:$i, qualify:function (t) {
        var n = t.indexOf(":"), e = t;
    ...
    var Ji = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/, Gi = d3.map({b:function (t) {
        return t.toString(2)
    }, c:function (t) {
    ...
    d3.interpolate = function (t, n) {
        ...
        for (ua.lastIndex = 0, r = 0; e = ua.exec(n); ++r)e.index && l.push(n.substring(o, c = e.index)), s.push({i:l.length, x:e[0]}), l.push(null), o = ua.lastIndex;
        for (n.length > o && l.push(n.substring(o)), r = 0, i = s.length; (e = ua.exec(t)) && i > r; ++r)if (a = s[r], a.x == e[0]) {
            if (a.i)if (null == l[a.i + 1])for (l[a.i - 1] += a.x, l.splice(a.i, 1), u = r + 1; i > u; ++u)s[u].i--; else for (l[a.i - 1] += a.x + l[a.i + 1], l.splice(a.i, 2), u = r + 1; i > u; ++u)s[u].i -= 2; else if (null == l[a.i + 1])l[a.i] = a.x; else for (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1), u = r + 1; i > u; ++u)s[u].i--;
            s.splice(r, 1), i--, r--
        ...
        return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), u.push({i:1, x:d3.interpolateNumber(o[0], c[0])}, {i:3, x:d3.interpolateNumber(o[1], c[1])})) : c[0] || c[1] ? r.push("translate(" + c + ")") : r.push(""), l != s ? (l - s > 180 ? s += 360 : s - l > 180 && (l += 360), u.push({i:r.push(r.pop() + "rotate(", null, ")") - 2, x:d3.interpolateNumber(l, s)})) : s && r.push(r.pop() + "rotate(" + s + ")"), f != h ? u.push({i:r.push(r.pop() + "skewX(", null, ")") - 2, x:d3.interpolateNumber(f, h)}) : h && r.push(r.pop() + "skewX(" + h + ")"), d[0] != g[0] || d[1] != g[1] ? (e = r.push(r.pop() + "scale(", null, ",", null, ")"), u.push({i:e - 4, x:d3.interpolateNumber(d[0], g[0])}, {i:e - 2, x:d3.interpolateNumber(d[1], g[1])})) : (1 != g[0] || 1 != g[1]) && r.push(r.pop() + "scale(" + g + ")"), e = u.length, function (t) {
    ...
    d3.svg.axis = function () {
        ...
        function u() {
            ...
            function h() {
                var t = u(), i = !1;
                m && (t[0] += m[0], t[1] += m[1]), S || (d3.event.altKey ? (p || (p = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]), k[0] = s[+(t[0] < p[0])][0], k[1] = s[+(t[1] < p[1])][1]) : p = null), _ && d(t, o, 0) && (e(b), i = !0), w && d(t, c, 1) && (r(b), i = !0), i && (n(b), M({type:"brush", mode:S ? "move" : "resize"}))
            }
        ...
        var i, a = j(t, "brushstart", "brush", "brushend"), o = null, c = null, l = $a[0], s = [
            [0, 0],
            [0, 0]
        ];
    ...
    d3.behavior = {}, d3.behavior.drag = function () {
        ...
        function n() {
            ...
            function u() {
                c({type:"dragend"}), h && (R(), d3.event.target === l && d.on("click.drag", i, !0)), d.on(null != s ? "touchmove.drag-" + s : "mousemove.drag", null).on(null != s ? "touchend.drag-" + s : "mouseup.drag", null)
            }
        ...
        function a(t) {
            i(), d3.event.preventDefault(), t({type:"zoom", scale:x, translate:b})
        }
    ...
    d3.layout = {}, d3.layout.bundle = function () {
        ...
        function t(i) {
            ...
            return l.forEach(function (t) {
                var n;
                s[t] = {data:i[t], value:n = a[t], startAngle:o, endAngle:o += n * c}
            }), s
        }
    ...
    }, "default":ur}), Qa = d3.map({silhouette:function (t) {
    ...
    d3.layout.histogram = function () {
        ...
        function n(e) {
            var i = e.children;
            if (i && i.length) {
                var a, o, c, l = f(e), s = [], h = i.slice(), g = 1 / 0, p = "slice" === d ? l.dx : "dice" === d || "slice-dice" === d && 1 & e.depth ? l.dy : Math.min(l.dx, l.dy);
                for (t(h, l.dx * l.dy / e.value), s.area = 0; (c = h.length) > 0;)s.push(a = h[c - 1]), s.area += a.area, "squarify" !== d || g >= (o = r(s, p)) ? (h.pop(), g = o) : (s.area -= s.pop().area, u(s, p, l, !1), p = Math.min(l.dx, l.dy), s.length = s.area = 0, g = 1 / 0);
    ...
    var uo, io, ao, oo, co, lo = {sphere:Pn, point:uu, lineStart:au, lineEnd:ou, polygonStart:function () {
    ...
    }}, vo = {point:zu, lineStart:Du, lineEnd:Lu, polygonStart:function () {
        vo.lineStart = Fu
    }, polygonEnd:function () {
    ...
    (d3.geo.stereographic = function () {
        ...
        for (n = 0; f > n; ++n)n !== p && (u = t[n][1] - t[p][1], r = t[n][0] - t[p][0], d.push({angle:Math.atan2(u, r), index:n}));
    ...
    d3.time.format = function (t) {
        ...
        return n.parse = function (n) {
            var e = {y:1900, m:0, d:1, H:0, M:0, S:0, L:0}, r = Wu(e, t, n, 0);
    ...
    var Do = Qu(To), Lo = Qu(qo), Fo = Qu(Co), Ho = ti(Co), Ro = Qu(zo), Po = ti(zo), jo = {"-":"", _:" ", 0:"0"}, Oo = {a:function (t) {
        return qo[t.getDay()]
    }, A:function (t) {
        return To[t.getDay()]
    }, b:function (t) {
        ...
        return"%"
    }}, Yo = {a:ei, A:ri, b:ui, B:ii, c:ai, d:di, e:di, H:gi, I:gi, L:vi, m:hi, M:pi, p:yi, S:mi, x:oi, X:ci, y:si, Y:li}, Uo = /^\s*\d+/, Io = d3.map({am:0, pm:1});
