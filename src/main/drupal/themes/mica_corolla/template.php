 ...
 */
function mica_corolla_preprocess_html(&$vars) {
  global $theme_key;
 ...
 */
function mica_corolla_process_html(&$vars) {
  if (module_exists('color')) {
    _color_html_alter($vars);
  }
}
function mica_corolla_process_page(&$vars) {
  if (module_exists('color')) {
 ...
 */
function mica_corolla_preprocess_block(&$vars) {
 ...
 */
function mica_corolla_tablesort_indicator($vars) {
 ...
 * @ingroup themeable
 */
function mica_corolla_fieldset($vars) {
